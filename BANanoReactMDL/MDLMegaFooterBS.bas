...
Public Sub Initialize(BR As BANanoReact, sid As String) As MDLMegaFooterBS
	ID = sid
	DDSInt = BR.div(ID).AddClass("mdl-mega-footer__bottom-section")
	BanReact = BR
...
'set logo
Sub SetLogo(t As String) As MDLMegaFooterBS
	DDSInt.AddReactElement(BanReact.CreateReactElement("div",Null,t).AddClass("mdl-logo"))
End Sub

'add a link
Sub AddLink(Label As String, href As String, target As String) As MDLMegaFooterBS
...
'ge the footer
Sub MegaFooterBS As ReactElement
